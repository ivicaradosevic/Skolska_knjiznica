...
public class IssueBookController implements Initializable {
    ...
    public void searchBooks(){
        ...
        try{
            ...
            String query = "SELECT id, title,author, isbn, publisher, edition, category_id, stock_number" +
    ...
    public void searchUsers(){
        ...
        try{
            ...
            String query = "SELECT id, first_name, last_name, oib, username, email, year, user_type_id FROM user WHERE OIB = ?";
    ...
    public void issueBook(){
        ...
        if(selectedBook == null || selectedUser == null || issueDate.getValue() == null){
            Alert alert = new Alert(Alert.AlertType.WARNING);
            alert.setTitle("Upozorenje");
            alert.setContentText("Korisnik, knjiga i datum posudbe moraju biti odabrani.");
            alert.showAndWait();
            return;
        }
        ...
        try{
            ...
            String checkQuery = "SELECT id FROM issuedbooks WHERE books_id = ? AND user_id = ?";
            ...
            if(rs.next()){
                Alert alert = new Alert(Alert.AlertType.WARNING);
                alert.setTitle("Upozorenje");
                alert.setContentText("Korisnik je već posudio odabranu knjigu. Odaberite drugu knjigu ili drugog korisnika.");
                alert.showAndWait();
                return;
            }
